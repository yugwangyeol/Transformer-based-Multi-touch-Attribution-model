    ...
    def train(self):
        ...
        for epoch in range(self.params.num_epoch):
            ...
            for batch in tqdm(self.train_iter):
                ...
                gender_output, age_output, conversion_output, attn_map = self.decoder(cam_sequential, cate_sequential, 
                ...
                loss, conversion_loss = self.criterion(gender_output, gender_label, age_output, age_label,output, target) # 
            ...
            print(f'\t Val. Loss: {valid_loss:.3f} |  Val. Conversion Loss : {valid_conversion_loss:.3f} | Val. ACC : {valid_acc:.3f} | Val. F1 : {valid_f1:.3f} | valid. AUC : {valid_auc:.3f} | valid. log : {valid_log:.3f}')
